...
const AreaResults = ({tasks, correctNum}) => {
      ...
      <div key={element.id} className={element.isCorrect? "correct" : "wrong"}>
        <div>
          ...
          <div>
            ...
            <div>
              <div>
                <span>Kerület = {element.perimeter}</span>
              </div>
              <div>
                <span>Terület = {element.area}</span>
              </div>
            </div>
          </div>
          <div>
            ...
            <div>
              <div>
                <span>Kerület = {element.userInput.perimeter}</span>
              </div>
              <div>
                <span>Terület = {element.userInput.area}</span>
              </div>
            </div>
          </div>
        </div>
